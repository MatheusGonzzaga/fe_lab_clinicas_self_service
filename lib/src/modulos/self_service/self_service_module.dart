...
import 'package:fe_lab_clinicas_self_service/src/modulos/self_service/documents/scan_confirm/documents_scan_confirm_router.dart';
...
class SelfServiceModule extends FlutterGetItModule {
  ...
  List<Bind<Object>> get bindings => [
        Bind.lazySingleton<InformationRepository>(
            (i) => InformationRepositoryImpl(restClient: i())),
        Bind.lazySingleton(
  ...
  Map<String, WidgetBuilder> get pages => {
        ...
        '/find-patient': (context) => const FindPatietRouter(),
