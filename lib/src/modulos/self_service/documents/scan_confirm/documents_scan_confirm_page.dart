...
import 'package:fe_lab_clinicas_self_service/src/modulos/self_service/documents/scan_confirm/documents_scan_confirm_controller.dart';
...
class DocumentsScanConfirmPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    controller.pathRemotStorage.listen(context, () {
      Navigator.of(context).pop();
      Navigator.of(context).pop(controller.pathRemotStorage.value);
    });
